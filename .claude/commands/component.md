...
### 1. Write Tests First
Create a `tests/components/[ComponentName].test.tsx` with 2-3 simple tests:
- Test that the component renders
- Test key elements are present (roles, test)
...
Iterate on component until all tests pass.
